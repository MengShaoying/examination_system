...
<body>
  ...
  <input type="radio" name="selection_type" value="SINGLE" title="单选" {{ 'SINGLE' === $question->selection_type?'checked':'' }}>
  <input type="radio" name="selection_type" value="MULTI" title="多选" {{ 'MULTI' === $question->selection_type?'checked':'' }}>
